...
// - protoc             v3.20.1
// source: internal/adapters/application/proto/svc.proto
...
func (c *loggerClient) Log(ctx context.Context, in *LogReq, opts ...grpc.CallOption) (*LogRes, error) {
	out := new(LogRes)
	err := c.cc.Invoke(ctx, "/application.Logger/Log", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Logger_Log_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/application.Logger/Log",
	}
...
var Logger_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.Logger",
	...
	Metadata: "internal/adapters/application/proto/svc.proto",
}
