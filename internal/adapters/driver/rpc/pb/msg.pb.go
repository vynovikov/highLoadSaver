...
type Message struct {
	...
	FieldValue []byte `protobuf:"bytes,4,opt,name=field_value,json=fieldValue,proto3" json:"field_value,omitempty"`
...
func (x *Message) GetFormName() string {
	if x != nil {
		return x.FormName
	}
	return ""
...
func (x *Message) GetFieldValue() []byte {
	if x != nil {
		return x.FieldValue
	}
	return nil
...
var file_internal_adapters_driver_rpc_proto_msg_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x73, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09,
	0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x07, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x74, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x6f, 0x72, 0x6d, 0x5f, 0x6e, 0x61,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x6c, 0x61, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04,
	0x6c, 0x61, 0x73, 0x74, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_internal_adapters_driver_rpc_proto_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_internal_adapters_driver_rpc_proto_msg_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: serialize.Message
}
